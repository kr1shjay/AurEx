...
export const perpetualOrderHistory = async (req, res) => {
    try {
        ...
        console.log("🚀 ~ file: report.controller.js ~ line 483 ~ perpetualOrderHistory ~ err", err)
...
export const perpetualTradeHistory = async (req, res) => {
    try {
        ...
        if (Export == 'csv' || Export == 'xls') {
            ...
            console.log("🚀 ~ file: report.controller.js ~ line 540 ~ perpetualTradeHistory ~ csvData", csvData)
            return res.csv(csvData)
        }
        if (Export == 'pdf') {
