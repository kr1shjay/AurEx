...
if (process.env.NODE_ENV === "production") {let key = {};
...
if (process.env.NODE_ENV === "production") {
  ...
  key = {
    ...
    DATABASE_URL:
      "mongodb://clux:Password__2022__PasworD@23.239.23.84:10330/clux",
    RUN_CRON: true,
    PORT: PORT,
    FRONT_URL: "https://cluxchange.com/",
    ADMIN_URL: "https://cluxchange.com/",
    SERVER_URL: `${API_URL}`,
    IMAGE_URL: `${API_URL}`,
...
export default {
  ...
  key = {
    ...
    ADMIN_URL: "https://aurexchange.com/",
    SERVER_URL: `${API_URL}`,
    IMAGE_URL: `${API_URL}`,
    RECAPTCHA_SECRET_KEY: "6Lf8HicjAAAAAO-0Whg1Y9g-O3iA4ghr2CI9oGZo",
    NUM_VERIFY: {
      API_KEY: "",
    },
    ...
    WAZIRIX: {
      API: "", //using for orderplace
      SECRET: "", //using for orderplace
    },
    ...
    COIN_GATE_WAY: {
      ...
      ETH: {
        URL: "http://52.197.200.124:3000",
        ADDRESS: "0xCA06797FC3795fc13A1646fB5fe4940f7582301c",
        PRIVATE_KEY:
          "",
      },
      BNB: {
